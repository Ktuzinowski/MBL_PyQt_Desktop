...
"}")
        ...
        self.channelTwo = QtWidgets.QComboBox(self.frame_15)
        self.channelTwo.setObjectName("channelTwo")
        self.channelTwo.addItem("")
        self.channelTwo.addItem("")
        self.channelTwo.addItem("")
        self.channelTwo.addItem("")
        self.horizontalLayout_14.addWidget(self.channelTwo)
        ...
        self.cellprobThreshold = QtWidgets.QDoubleSpinBox(self.frame_15)
        self.cellprobThreshold.setSingleStep(0.5)
        self.cellprobThreshold.setProperty("value", 0.4)
        self.cellprobThreshold.setObjectName("cellprobThreshold")
        self.horizontalLayout_16.addWidget(self.cellprobThreshold)
        ...
        self.stitchThreshold = QtWidgets.QDoubleSpinBox(self.frame_15)
        self.stitchThreshold.setSingleStep(0.5)
        self.stitchThreshold.setObjectName("stitchThreshold")
        self.horizontalLayout_17.addWidget(self.stitchThreshold)
        ...
        self.modelToRun = QtWidgets.QComboBox(self.frame_15)
        self.modelToRun.setObjectName("modelToRun")
        self.modelToRun.addItem("")
        self.modelToRun.addItem("")
        self.modelToRun.addItem("")
        self.modelToRun.addItem("")
        self.modelToRun.addItem("")
        self.horizontalLayout_18.addWidget(self.modelToRun)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.channelTwo.setItemText(0, _translate("MainWindow", "0: None"))
        self.channelTwo.setItemText(1, _translate("MainWindow", "1: Red"))
        self.channelTwo.setItemText(2, _translate("MainWindow", "2: Green"))
        self.channelTwo.setItemText(3, _translate("MainWindow", "3: Blue"))
        ...
        self.modelToRun.setItemText(0, _translate("MainWindow", "Cyto2"))
        self.modelToRun.setItemText(1, _translate("MainWindow", "Cyto"))
        self.modelToRun.setItemText(2, _translate("MainWindow", "Nuclei"))
        self.modelToRun.setItemText(3, _translate("MainWindow", "Tissuenet"))
        self.modelToRun.setItemText(4, _translate("MainWindow", "Livecell"))
