...
"The size is represented at the bottom of the view with a purple disk."))
        ...
        self.flowThresholdValue.setToolTip(_translate("MainWindow", "Threshold on cell probability output to seed cell masks (set lower to include more pixels or higher to include fewer, e.g. in range from (-6, 6))"))
