...
"}")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 230, 940))
...
"}")
        ...
        self.horizontalLayout_21.setContentsMargins(-1, -1, -1, 10)
...
"}")
        ...
        self.cellprobThresholdValue.setProperty("value", 0.4)
...
"The size is represented at the bottom of the view with a purple disk."))
        ...
        self.modelName.setItemText(1, _translate("MainWindow", "Cyto"))
        self.modelName.setItemText(2, _translate("MainWindow", "Nuclei"))
        self.modelName.setItemText(3, _translate("MainWindow", "Tissuenet"))
        self.modelName.setItemText(4, _translate("MainWindow", "Livecell"))
